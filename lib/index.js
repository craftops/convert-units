...
Converter.prototype.toBest = function(options) {
  ...
  var targetSystem = options.system || this.origin.system;
  ...
  */
  each(this.possibilities(), function(possibility) {
    ...
    if (isIncluded && unit.system === targetSystem) {
...
* converted to.
*/
Converter.prototype.possibilities = function (measure, system) {
  var possibilities = [];
  if(!this.origin && !measure) {
    ...
    var targetSystem = system || this.origin.system;
	  ...
	  each(measures[measure], function (units, system) {
	    if(system == '_anchors' || system !== targetSystem)
	      return false;
